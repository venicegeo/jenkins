...
class Repos {
  static repos = [
    [
      ...
      team: 'piazza',
      manual: ['gitlab_push'],
      pipeline: ['ionchannel_pom', 'sonar', 'archive', 'cf_push_int', 'zap', 'cf_bg_deploy_int', 'int-release', 'run_integration_tests', 'cf_push_stage', 'cf_bg_deploy_stage', 'stage-release', 'fortify']
    ],[
      reponame: 'pz-docs',
      team: 'piazza',
      manual: ['gitlab_push'],
      ...
      team: 'piazza',
      manual: ['gitlab_push'],
      pipeline: ['sonar', 'ionchannel_pom', 'archive', 'cf_push_int', 'zap', 'cf_bg_deploy_int', 'int-release', 'run_integration_tests', 'cf_push_stage', 'cf_bg_deploy_stage', 'stage-release', 'fortify']
    ],[
      ...
      team: 'piazza',
      manual: ['gitlab_push'],
      pipeline: ['test', 'archive', 'cf_push_int', 'zap', 'cf_bg_deploy_int', 'int-release', 'run_integration_tests', 'cf_push_stage', 'cf_bg_deploy_stage', 'stage-release']
    ],[
      reponame: 'pz-sak',
      team: 'piazza',
      manual: ['gitlab_push'],
      pipeline: ['karma', 'sonar', 'archive', 'cf_push_int', 'zap', 'cf_bg_deploy_int', 'int-release', 'run_integration_tests', 'cf_push_stage', 'cf_bg_deploy_stage', 'stage-release']
    ],[
