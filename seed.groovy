...
core_steps.each{ repo, jobkey ->
  ...
  core_cps = core_cps + """
    build job: "${repo}/${jobkey}", parameters: [ [\$class: 'StringParameterValue', name: 'space', value: "\$space"], [\$class: 'StringParameterValue', name: 'revision', value: "\$${repo}_revision"] ], wait: true
"""
}
