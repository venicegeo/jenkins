...
class PipelineJob {
  ...
  def envs = [
    ...
    vg_prod: [space: 'prod',            domain: 'venicegeo.io',            api: 'https://api.venicegeo.io'            ],
  ...
  def pcfvars="""
    case \$space in
      ...
      vg_prod) export PCF_SPACE=${envs.vg_prod.space}; export PCF_DOMAIN=${envs.vg_prod.domain}; export PCF_API=${envs.vg_prod.api}; export PCF_ORG=piazza ;;
