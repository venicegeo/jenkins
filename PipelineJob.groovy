...
class PipelineJob {
  ...
  def base() {
    this.jobject.with {
      ...
      parameters {
        choiceParam('domain', this.domains,'PCF Domain/Space to target<br>geointservices.io<br>production,stage.geointservices.io<br>beta,int.geointservices.io = CI')
